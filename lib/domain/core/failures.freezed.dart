...
// ignore: unused_element
  Multline<T> multiline<T>({@required T failedValue}) {
    return Multline<T>(
      failedValue: failedValue,
    );
  }
...
mixin _$ValueFailure<T> {
  ...
  Result map<Result extends Object>({
    ...
    @required Result multiline(Multline<T> value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result multiline(Multline<T> value),
...
abstract class $MultlineCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
...
class _$MultlineCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $MultlineCopyWith<T, $Res> {
  _$MultlineCopyWithImpl(Multline<T> _value, $Res Function(Multline<T>) _then)
      : super(_value, (v) => _then(v as Multline<T>));

  @override
  Multline<T> get _value => super._value as Multline<T>;

  @override
  $Res call({
    Object failedValue = freezed,
  }) {
    return _then(Multline<T>(
      failedValue:
          failedValue == freezed ? _value.failedValue : failedValue as T,
    ));
  }
...
class _$Multline<T> implements Multline<T> {
  const _$Multline({@required this.failedValue}) : assert(failedValue != null);
  ...
  $MultlineCopyWith<T, Multline<T>> get copyWith =>
      _$MultlineCopyWithImpl<T, Multline<T>>(this, _$identity);
...
abstract class Multline<T> implements ValueFailure<T> {
  const factory Multline({@required T failedValue}) = _$Multline<T>;
